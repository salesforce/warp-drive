...
class PyCUDALogController:
    ...
    def update_log(self, data_manager: PyCUDADataManager, step: int):
        """
    ...
    def reset_log(self, data_manager: PyCUDADataManager, env_id: int = 0):
        """
    ...
    def _cuda_check_last_valid_step(self, data_manager: PyCUDADataManager):
        """
